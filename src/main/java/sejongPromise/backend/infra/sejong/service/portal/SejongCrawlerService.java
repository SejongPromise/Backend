...
public class SejongCrawlerService {
    ...
    public PortalStudentInfo crawlStudentInfo(SejongAuth auth){
    ...
    private PortalStudentInfo parseHtml(String html) {
        ...
        return new PortalStudentInfo(name, studentId, major);
